...
async function fetchMembers() {
    try {
        const response = await fetch('https://www.rootairs.com/api/admin/get_members', {
           method: 'GET',
           credentials: 'include'
        });
        if (!response.ok) {
...
async function deleteMember(id) {
    ...
    try {
        ...
        const response = await fetch('https://www.rootairs.com/api/admin/delete_member', {
            method: 'POST',
...
async function searchMembers() {
    ...
    try {
        const response = await fetch(`https://www.rootairs.com/api/admin/search_members?keyword=${encodeURIComponent(keyword)}`, {
            method: 'GET',
            credentials: 'include'
        });
...
async function updateMileage(id) {
    ...
    try {
        const response = await fetch('https://www.rootairs.com/api/admin/update_mileage', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            credentials: 'include',
