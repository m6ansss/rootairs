    ...
    document.addEventListener("DOMContentLoaded", function () {
        fetch("https://https://www.rootairs.com/api/member/status", {
                mcdethod: "GET",
                credentials:"include"
            })
                ...
                if (data.is_authenticated) {
                    if (data.is_admin) {
                        ...
                        navbarMember.innerHTML = `
                            <li class="navbar_signup"><a href="https://https://www.rootairs.com/api/member/logout">로그아웃</a></li>
                        ...
                        navbarMember.innerHTML = `
                            <li class="navbar_signup"><a href="https://https://www.rootairs.com/api/member/logout">로그아웃</a></li>
                            <li class="navbar_login"><a href="https://https://www.rootairs.com/mypage/mypage.html">마이페이지</a></li>
                        `;
                    }
                } else {
                    // ✅ 비로그인 상태
                    navbarMember.innerHTML = `
                        <li class="navbar_signup"><a href="https://https://www.rootairs.com/member/member_email.html">회원가입</a></li>
                        <li class="navbar_login"><a href="https://https://www.rootairs.com/member/member_login.html">로그인</a></li>
                    `;
                }
            })
...
async function fetchMembers() {
    try {
        const response = await fetch('https://https://www.rootairs.com/api/admin/get_members', {
           method: 'GET',
           credentials: 'include'
        });
        if (!response.ok) {
...
async function deleteMember(id) {
    ...
    try {
        ...
        const response = await fetch('https://https://www.rootairs.com/api/admin/delete_member', {
            method: 'POST',
...
async function updateMileage(id) {
    ...
    try {
        const response = await fetch('https://https://www.rootairs.com/api/admin/update_mileage', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            credentials: 'include',
