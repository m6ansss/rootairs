...
document.getElementById("verifyButton").addEventListener("click", function () {
    ...
    fetch("https://www.rootairs.com/api/member/verify", {
        method: "POST",
...
function requestVerification() {
    ...
    $.ajax({
        url: 'https://www.rootairs.com/api/member/request-verification',
        method: 'POST',
...
function verifyOTP() {
    ...
    $.ajax({
        url: 'https://www.rootairs.com/api/member/verify',
        method: 'POST',
        contentType: 'application/json',
...
$(document).ready(function() {
    $.ajax({
        url:'https://www.rootairs.com/api/member/get_verified_email', // Flask 백엔드 주소
        method: 'GET',
