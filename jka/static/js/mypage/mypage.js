  ...
  // ✅ 회원 정보 수정 버튼 클릭 시 이벤트
    ...
    if (editProfileBtn) {
        editProfileBtn.addEventListener("click", function () {
            fetch("https://www.rootairs.com/api/mypage/edit", {
                method: "GET",
                credentials: "include",
                mode: "cors"
            })
    ...
    const deleteAccountBtn = document.getElementById("deleteAccountBtn");
     if (deleteAccountBtn) {
        deleteAccountBtn.addEventListener("click", function () {
            window.location.href = "https://www.rootairs.com/mypage/mypage_cancel.html";
        });
    }
});
...
function loadUserInfo() {
    fetch("https://www.rootairs.com/api/mypage", {
        method: "GET",
        credentials: "include",
        mode: "cors"
    })
...
async function generateTickets() {
    try {
        const response = await fetch("https://www.rootairs.com/api/mypage/get_tickets", {
            method: "GET",
            credentials: "include",
            mode: "cors"
        });
