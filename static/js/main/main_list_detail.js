...
console.log("📢 [JS] API 요청 시작: POST https://www.rootairs.com/api/main/book");
fetch("https://www.rootairs.com/api/main/book", {
    method: "POST",
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!flightId) {
        alert("항공편 ID가 없습니다.");
        window.location.href = "https://www.rootairs.com/main/main_list.html";
        return;
    }

    // ✅ API 요청 URL 생성
    const apiUrl = `https://www.rootairs.com/api/main/list/detail/${flightId}?passengers=${passengers}`;
