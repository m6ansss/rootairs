...
async function fetchUserStatus() {
    try {
        const response = await fetch("https://www.rootairs.com/api/member/status", {
            method: "GET",
            credentials: "include"
        });
...
function fetchNoticeDetail(noticeId) {
    ...
    fetch(`https://www.rootairs.com/api/notices/detail/${noticeId}`)
...
function deleteNotice(event) {
    ...
    fetch(`https://www.rootairs.com/api/notices/delete/${noticeId}`, {
        method: "DELETE",
        credentials: "include"
    })
    .then(response => response.json())
